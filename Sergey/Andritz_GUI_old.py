<<<<<<< HEAD:Sergey/Andritz_GUI_old.py
# QThread, QFileDialog
...
from re import X
from turtle import color, width
>>>>>>> 2f193aacf2187cf0b7ac99e9ac52cf277a9c0345:Andritz_GUI/Andritz_GUI/VS_Andritz_GUI.py
import numpy as np
import os
# from os import walk
import sys
...
class MainWindow(QMainWindow):
    ...
    def Real_Time_Button_Click(self):    
        ...
        if(bool(self.proc_settings.get("RealT_show_processed_signals_checkbox_3"))==True):                        
            ...
            self.RT_fig_proc_results=RTPlotWidget(colors_id=self.colors_id)
...
class My_RT_Thread(threading.Thread):    
    finished = signal.signal(signal.SIGINT, signal.SIG_DFL)
...
class RTPlotWidget(PySide6.QtWidgets.QWidget):
