...
class Ui_EmpaGUI(object):
    def setupUi(self, EmpaGUI):
        ...
        self.train_dropdown_2 = QComboBox(self.groupBox_3)
        self.train_dropdown_2.addItem("")
        self.train_dropdown_2.addItem("")
        self.train_dropdown_2.setObjectName(u"train_dropdown_2")
        self.train_dropdown_2.setGeometry(QRect(10, 15, 311, 24))
        ...
        self.predict_button = QPushButton(self.tab)
        self.predict_button.setObjectName(u"predict_button")
        self.predict_button.setGeometry(QRect(0, 240, 421, 81))
    ...
    def retranslateUi(self, EmpaGUI):
        ...
        self.train_dropdown_2.setItemText(0, QCoreApplication.translate("EmpaGUI", u"Folder", None))
        self.train_dropdown_2.setItemText(1, QCoreApplication.translate("EmpaGUI", u"RealTime", None))

        self.train_dropdown_2.setCurrentText("")
        self.train_dropdown_2.setPlaceholderText(QCoreApplication.translate("EmpaGUI", u"Autoencoder", None))
