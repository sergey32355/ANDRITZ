...
################################################################################
## Form generated from reading UI file 'empa_guiNXGVFB.ui'
##
...
class Ui_EmpaGUI(object):
    def setupUi(self, EmpaGUI):
        ...
        self.Classification_set_as_main_model_button = QPushButton(self.groupBox_7)
        self.Classification_set_as_main_model_button.setObjectName(u"Classification_set_as_main_model_button")
        self.Classification_set_as_main_model_button.setGeometry(QRect(160, 68, 121, 31))
        ...
        self.Settings_MEL_num_ffts.setGeometry(QRect(63, 21, 61, 22))
    ...
    def retranslateUi(self, EmpaGUI):
        ...
        self.Classification_set_as_main_model_button.setText(QCoreApplication.translate("EmpaGUI", u"Save feat. to file", None))
        ...
        self.classification_preproc_dropdown.setItemText(4, QCoreApplication.translate("EmpaGUI", u"torch_MFCC", None))
        self.classification_preproc_dropdown.setItemText(5, QCoreApplication.translate("EmpaGUI", u"torch_WFFT", None))
        self.classification_preproc_dropdown.setItemText(6, QCoreApplication.translate("EmpaGUI", u"torch_GrifLim", None))
        self.classification_preproc_dropdown.setItemText(7, QCoreApplication.translate("EmpaGUI", u"torch_LFCC", None))
        self.classification_preproc_dropdown.setItemText(8, QCoreApplication.translate("EmpaGUI", u"torch_SpecCentr", None))
        self.classification_preproc_dropdown.setItemText(9, QCoreApplication.translate("EmpaGUI", u"tocrh_DWT", None))

        self.classification_preproc_dropdown.setCurrentText(QCoreApplication.translate("EmpaGUI", u"None", None))
